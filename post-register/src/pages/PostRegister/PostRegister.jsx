...
function PostRegister() {
    ...
    const options = [
        ...
        { value: 'databace', label: 'Databace' },
    ];

    const readFileUrlDataUrl = (file) => {
            ...
            <div css={s.layout}>
                <main css={s.main}>
                    <div css={s.titleInput}>
                        <TextInput placeholder={"작성하실 글의 제목을 입력해 주세요."} value={title} onChange={handleTitleOnChange} />
                    </div>
                    <MDEditor
                        value={value}
                        onChange={setValue}
                ...
                <aside css={s.sidebar}>
                    <div css={s.thumdnail(thumbnail.dataUrl)}>
                        <label>썸네일</label>
